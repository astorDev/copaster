...
public class CopyCommand : Command
{
    ...
    public CopyCommand(ILogger<CopyCommand> logger, ILogger<RemainingCommand.Logic> remainingCommandLogicLogger) : base("toregistry", "Greet a person by name.")
    {
        Add(pathArgument);
        Add(nameOption);
        SetAction(Execute);
    ...
    private void Execute(ParseResult parseResult)
    {
        ...
        remainingCommandLogic.GetRemainingFiles(new Copaster.Folder(path));
    }
}