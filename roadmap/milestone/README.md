...
- [ ] Paste util, handing smart insertion of the files in a global registry. [Under Design](../../paste/README.md)
- [ ] Helper Utilities and modules, making "smart" copying possible
  - [ ] Ignore util, providing sanitized list of files for copy util to copy. [Under Design](../../copy/README.md)
